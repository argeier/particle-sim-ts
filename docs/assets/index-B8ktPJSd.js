...
`].filter(fi).join(`
`)),a=Us(a),a=Va(a,e),a=Ga(a,e),o=Us(o),o=Va(o,e),o=Ga(o,e),a=ka(a),o=ka(o),e.isRawShaderMaterial!==!0&&(y=`#version 300 es
...
}`;function Sp(i){const t=document.createElement("style");t.innerHTML=i;const e=document.querySelector("head link[rel=stylesheet], head style");e?document.head.insertBefore(t,e):document.head.appendChild(t)}let eo=!1;class $s{constructor({parent:t,autoPlace:e=t===void 0,container:n,width:r,title:s="Controls",closeFolders:a=!1,injectStyles:o=!0,touchStyles:l=!0}={}){if(this.parent=t,this.root=t?t.root:this,this.children=[],this.controllers=[],this.folders=[],this._closed=!1,this._hidden=!1,this.domElement=document.createElement("div"),this.domElement.classList.add("lil-gui"),this.$title=document.createElement("div"),this.$title.classList.add("title"),this.$title.setAttribute("role","button"),this.$title.setAttribute("aria-expanded",!0),this.$title.setAttribute("tabindex",0),this.$title.addEventListener("click",()=>this.openAnimated(this._closed)),this.$title.addEventListener("keydown",c=>{(c.code==="Enter"||c.code==="Space")&&(c.preventDefault(),this.$title.click())}),this.$title.addEventListener("touchstart",()=>{},{passive:!0}),this.$children=document.createElement("div"),this.$children.classList.add("children"),this.domElement.appendChild(this.$title),this.domElement.appendChild(this.$children),this.title(s),this.parent){this.parent.children.push(this),this.parent.folders.push(this),this.parent.$children.appendChild(this.domElement);return}this.domElement.classList.add("root"),l&&this.domElement.classList.add("allow-touch-styles"),!eo&&o&&(Sp(Mp),eo=!0),n?n.appendChild(this.domElement):e&&(this.domElement.classList.add("autoPlace"),document.body.appendChild(this.domElement)),r&&this.domElement.style.setProperty("--width",r+"px"),this._closeFolders=a}add(t,e,n,r,s){if(Object(n)===n)return new vp(this,t,e,n);const a=t[e];switch(typeof a){case"number":return new _p(this,t,e,n,r,s);case"boolean":return new hp(this,t,e);case"string":return new xp(this,t,e);case"function":return new Jr(this,t,e)}console.error(`gui.add failed
	property:`,e,`
	object:`,t,`
	value:`,a)}addColor(t,e,n=1){return new gp(this,t,e,n)}addFolder(t){const e=new $s({parent:this,title:t});return this.root._closeFolders&&e.close(),e}load(t,e=!0){return t.controllers&&this.controllers.forEach(n=>{n instanceof Jr||n._name in t.controllers&&n.load(t.controllers[n._name])}),e&&t.folders&&this.folders.forEach(n=>{n._title in t.folders&&n.load(t.folders[n._title])}),this}save(t=!0){const e={controllers:{},folders:{}};return this.controllers.forEach(n=>{if(!(n instanceof Jr)){if(n._name in e.controllers)throw new Error(`Cannot save GUI with duplicate property "${n._name}"`);e.controllers[n._name]=n.save()}}),t&&this.folders.forEach(n=>{if(n._title in e.folders)throw new Error(`Cannot save GUI with duplicate folder "${n._title}"`);e.folders[n._title]=n.save()}),e}open(t=!0){return this._setClosed(!t),this.$title.setAttribute("aria-expanded",!this._closed),this.domElement.classList.toggle("closed",this._closed),this}close(){return this.open(!1)}_setClosed(t){this._closed!==t&&(this._closed=t,this._callOnOpenClose(this))}show(t=!0){return this._hidden=!t,this.domElement.style.display=this._hidden?"none":"",this}hide(){return this.show(!1)}openAnimated(t=!0){return this._setClosed(!t),this.$title.setAttribute("aria-expanded",!this._closed),requestAnimationFrame(()=>{const e=this.$children.clientHeight;this.$children.style.height=e+"px",this.domElement.classList.add("transition");const n=s=>{s.target===this.$children&&(this.$children.style.height="",this.domElement.classList.remove("transition"),this.$children.removeEventListener("transitionend",n))};this.$children.addEventListener("transitionend",n);const r=t?this.$children.scrollHeight:0;this.domElement.classList.toggle("closed",!t),requestAnimationFrame(()=>{this.$children.style.height=r+"px"})}),this}title(t){return this._title=t,this.$title.textContent=t,this}reset(t=!0){return(t?this.controllersRecursive():this.controllers).forEach(n=>n.reset()),this}onChange(t){return this._onChange=t,this}_callOnChange(t){this.parent&&this.parent._callOnChange(t),this._onChange!==void 0&&this._onChange.call(this,{object:t.object,property:t.property,value:t.getValue(),controller:t})}onFinishChange(t){return this._onFinishChange=t,this}_callOnFinishChange(t){this.parent&&this.parent._callOnFinishChange(t),this._onFinishChange!==void 0&&this._onFinishChange.call(this,{object:t.object,property:t.property,value:t.getValue(),controller:t})}onOpenClose(t){return this._onOpenClose=t,this}_callOnOpenClose(t){this.parent&&this.parent._callOnOpenClose(t),this._onOpenClose!==void 0&&this._onOpenClose.call(this,t)}destroy(){this.parent&&(this.parent.children.splice(this.parent.children.indexOf(this),1),this.parent.folders.splice(this.parent.folders.indexOf(this),1)),this.domElement.parentElement&&this.domElement.parentElement.removeChild(this.domElement),Array.from(this.children).forEach(t=>t.destroy())}controllersRecursive(){let t=Array.from(this.controllers);return this.folders.forEach(e=>{t=t.concat(e.controllersRecursive())}),t}foldersRecursive(){let t=Array.from(this.folders);return this.folders.forEach(e=>{t=t.concat(e.foldersRecursive())}),t}}class Ep{constructor(){re(this,"scene");re(this,"camera");re(this,"renderer");re(this,"composer");re(this,"attractionPoint",new U);re(this,"particles");re(this,"border");re(this,"isLeftMouseDown",!1);re(this,"isRightMouseDown",!1);re(this,"params",{color:"#88ccff",particleCount:1e3,attractionStrength:.1,repulsionStrength:.15,maxSpeed:8,particleSize:8,gravity:.2,friction:.98,stopThreshold:.05});re(this,"windowWidth",window.innerWidth);re(this,"windowHeight",window.innerHeight);re(this,"onWindowResize",()=>{this.windowWidth=window.innerWidth,this.windowHeight=window.innerHeight,this.camera.left=-this.windowWidth/2,this.camera.right=this.windowWidth/2,this.camera.top=this.windowHeight/2,this.camera.bottom=-this.windowHeight/2,this.camera.updateProjectionMatrix(),this.renderer.setSize(this.windowWidth,this.windowHeight),this.composer.setSize(this.windowWidth,this.windowHeight),this.createBorder()});re(this,"updateMousePosition",t=>{const e=this.renderer.domElement.getBoundingClientRect();this.attractionPoint.x=t.clientX-e.left-this.windowWidth/2,this.attractionPoint.y=-(t.clientY-e.top-this.windowHeight/2)});re(this,"onMouseDown",t=>{t.button===0&&(this.isLeftMouseDown=!0),t.button===2&&(this.isRightMouseDown=!0),this.updateMousePosition(t)});re(this,"onMouseUp",t=>{t.button===0&&(this.isLeftMouseDown=!1),t.button===2&&(this.isRightMouseDown=!1)});re(this,"onMouseMove",t=>{(this.isLeftMouseDown||this.isRightMouseDown)&&this.updateMousePosition(t)});re(this,"animate",()=>{requestAnimationFrame(this.animate),this.updateParticles(),this.composer.render()});this.scene=new jf,this.camera=new ks(-this.windowWidth/2,this.windowWidth/2,this.windowHeight/2,-this.windowHeight/2,.1,100),this.camera.position.z=10,this.renderer=new Zf({antialias:!0,alpha:!0}),this.renderer.setSize(this.windowWidth,this.windowHeight),this.renderer.setClearColor(0,1),document.body.appendChild(this.renderer.domElement),this.composer=new op(this.renderer),this.composer.addPass(new lp(this.scene,this.camera)),this.composer.addPass(new ri(new At(this.windowWidth,this.windowHeight),1.5,.4,.1)),this.particles=this.createParticles(),this.createBorder(),this.initGUI(),this.addEventListeners(),this.animate()}createParticles(){const t=[],e=new Xs(1,16),n=new Nt(this.params.color);for(let r=0;r<this.params.particleCount;r++){const s=(Math.random()-.5)*this.windowWidth,a=(Math.random()-.5)*this.windowHeight,o=new fn({color:n.clone(),transparent:!0,opacity:.8}),l=new Fe(e,o);l.position.set(s,a,0),l.scale.set(this.params.particleSize,this.params.particleSize,1),this.scene.add(l),t.push({mesh:l,position:new At(s,a),velocity:new At((Math.random()-.5)*4,(Math.random()-.5)*4),baseColor:n.clone()})}return t}createBorder(){this.border&&this.scene.remove(this.border);const t=new tp(new Si(this.windowWidth,this.windowHeight)),e=new Fo({color:16777215});this.border=new Qf(t,e),this.scene.add(this.border)}updateParticles(){const t=this.params.particleSize,e=this.windowWidth/2,n=this.windowHeight/2;this.particles.forEach(r=>{if(this.isLeftMouseDown||this.isRightMouseDown){const a=new At(this.attractionPoint.x,this.attractionPoint.y),o=a.distanceTo(r.position),l=Math.min(this.windowWidth,this.windowHeight);if(o<l){const c=a.clone().sub(r.position).normalize(),u=this.isLeftMouseDown?this.params.attractionStrength:-this.params.repulsionStrength;if(r.velocity.addScaledVector(c,u*100),r.mesh.material instanceof fn){const d=this.isLeftMouseDown?(1-o/l)*.5:o/l*.5;r.mesh.material.opacity=Math.min(.8+d,1)}}else r.mesh.material instanceof fn&&(r.mesh.material.opacity=.8)}else r.mesh.material instanceof fn&&(r.mesh.material.opacity=.8);r.velocity.y-=this.params.gravity;const s=r.velocity.length();s>this.params.maxSpeed&&r.velocity.multiplyScalar(this.params.maxSpeed/s),r.position.add(r.velocity),r.position.x<-e+t&&(r.position.x=-e+t,r.velocity.x*=-.9),r.position.x>e-t&&(r.position.x=e-t,r.velocity.x*=-.9),r.position.y<-n+t&&(r.position.y=-n+t,r.velocity.y*=-.9),r.position.y>n-t&&(r.position.y=n-t,r.velocity.y*=-.9),r.velocity.multiplyScalar(this.params.friction),r.velocity.length()<this.params.stopThreshold&&r.velocity.set(0,0)});for(let r=0;r<this.particles.length;r++)for(let s=r+1;s<this.particles.length;s++){const a=this.particles[r],o=this.particles[s],l=a.position.clone().sub(o.position),c=l.length(),u=t*2;if(c>0&&c<u){const d=u-c,f=l.clone().normalize();a.position.add(f.clone().multiplyScalar(d/2)),o.position.sub(f.clone().multiplyScalar(d/2));const _=a.velocity.clone().sub(o.velocity).dot(f);if(_<0){const v=-_;a.velocity.add(f.clone().multiplyScalar(v)),o.velocity.sub(f.clone().multiplyScalar(v))}}}this.particles.forEach(r=>{r.mesh.position.set(r.position.x,r.position.y,0)})}initGUI(){const t=new $s;t.addColor(this.params,"color").name("Particle Color").onChange(()=>this.updateParticleColors()),t.add(this.params,"attractionStrength",0,.5).name("Attraction Strength"),t.add(this.params,"repulsionStrength",0,.5).name("Repulsion Strength"),t.add(this.params,"maxSpeed",0,20).name("Max Speed"),t.add(this.params,"particleSize",2,20).name("Particle Size").onChange(()=>this.updateParticleSizes()),t.add(this.params,"gravity",0,2).name("Gravity"),t.add(this.params,"friction",.9,1).name("Friction"),t.add(this.params,"stopThreshold",.01,.2).name("Stop Threshold")}updateParticleSizes(){this.particles.forEach(t=>{t.mesh.scale.set(this.params.particleSize,this.params.particleSize,1)})}updateParticleColors(){const t=new Nt(this.params.color);this.particles.forEach(e=>{e.baseColor=t.clone(),e.mesh.material instanceof fn&&(e.mesh.material.color=t.clone())})}addEventListeners(){window.addEventListener("resize",this.onWindowResize),window.addEventListener("mousemove",this.onMouseMove),window.addEventListener("mousedown",this.onMouseDown),window.addEventListener("mouseup",this.onMouseUp),window.addEventListener("contextmenu",t=>t.preventDefault())}}new Ep;
//# sourceMappingURL=index-B8ktPJSd.js.map
